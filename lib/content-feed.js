...
export function renderContentIndex() {
  ...
  return textBlock([
    ...
    '',
    'Positioning',
    'Seyko Studios is an intelligence-led digital agency helping operators with branding, web development, SEO, data intelligence, selective marketing, and market intelligence before spending more on growth.',
    '',
    'Digital agency service pages',
    `- Digital Agency Services: ${siteUrl}/services`,
    ...services.map(service => `- ${service.title}: ${absoluteUrl(service.path)}`),
    '',
    ...
    '',
    'Conversion path',
    `Request a strategy call: ${siteUrl}/request-snapshot`,
