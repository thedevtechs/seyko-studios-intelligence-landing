  ...
  return `
    <section class="page-hero">
      <div class="container">
        ...
        <div class="hero-actions">${cta('/request-snapshot', 'Request Your Free Snapshot')}${ghost('/industry-intelligence', 'See the intelligence page')}</div>
      </div>
    </section>
    ...
    ${renderFinalCta('Turn the question into a market read.', 'Send the site, market, and lane. We will tell you whether the first snapshot makes sense.', 'Request Your Free Snapshot')}
  `;
}
  ...
  return `
    <section class="page-hero">
      <div class="container">
        ...
        <div class="hero-actions">${cta('/request-snapshot', 'Request Your Free Snapshot')}${ghost('/market-intelligence-agency', 'Market intelligence agency')}${ghost('/business-data-intelligence', 'Business data intelligence')}</div>
      </div>
    </section>
    ...
    ${renderFinalCta('Bring the decision, not a vague brief.', 'Send one market, one service line, and the move you are considering. We will inspect the evidence before recommending the next step.', 'Request Your Free Snapshot')}
  `;
}
  ...
  return `
    <section class="page-hero">
      <div class="container">
        ...
        <div class="hero-actions">${cta('/request-snapshot', 'Request Your Free Snapshot')}${ghost('/methodology', 'See methodology')}${ghost('/pricing', 'See pricing')}</div>
      </div>
    </section>
    ...
    ${renderFinalCta('Want this built for your market?', 'Send one market, one service line, and the decision you are considering. We will inspect the evidence before recommending the next step.', 'Request Your Free Snapshot')}
  `;
}
  ...
  return `
    <section class="page-hero">
      <div class="container">
        ...
        <div class="hero-actions">${cta('/request-snapshot', 'Request Your Free Snapshot')}${ghost('/insights/competitive-intelligence-local-markets', 'Read local competitor guide')}${ghost('/pricing', 'See pricing')}</div>
      </div>
    </section>
    ...
    ${renderFinalCta('Bring the competitor question.', 'Send one market, one service line, and the competitor pressure you are trying to understand. We will inspect the visible evidence before recommending the next move.', 'Request Your Free Snapshot')}
  `;
}
  ...
  return `
    <section class="page-hero">
      <div class="container">
        ...
        <div class="hero-actions">${cta('/request-snapshot', 'Request Your Free Snapshot')}${ghost('/content-index.txt', 'Text content index')}</div>
      </div>
    </section>
    ...
    ${renderFinalCta('Need the answer for your market?', 'Send one market, one service line, and the decision in front of you. We will tell you whether a snapshot makes sense.', 'Request Your Free Snapshot')}
  `;
}
  ...
  return `
    <section class="page-hero">
      <div class="container">
        ...
        <div class="hero-actions">${cta('/request-snapshot', 'Request Your Free Snapshot')}${ghost('/methodology', 'See methodology')}${ghost('/insights', 'Read operator insights')}${ghost('/pricing', 'See pricing')}</div>
      </div>
    </section>
    ...
    ${renderFinalCta('Bring us the market question.', 'Send one market, one service line, and the decision you are trying to make. We will tell you whether the snapshot is the right first move.', 'Request Your Free Snapshot')}
  `;
}
  ...
  return `
    <section class="page-hero">
      <div class="container">
        ...
        <div class="hero-actions">${cta('/request-snapshot', 'Request Your Free Snapshot')}${ghost('/business-data-intelligence', 'Business data intelligence')}${ghost('/industry-intelligence', 'Industry intelligence')}${ghost('/pricing', 'See pricing')}</div>
      </div>
    </section>
    ...
    ${renderFinalCta('Bring the decision that needs a sharper read.', 'Send the market, service line, and business context. We will tell you whether a snapshot is the right first move.', 'Request Your Free Snapshot')}
  `;
}
  ...
  return `
    <section class="page-hero">
      <div class="container">
        ...
        <div class="hero-actions">${cta('/request-snapshot', 'Request Your Free Snapshot')}${ghost('/methodology', 'See methodology')}${ghost('/insights/business-data-market-intelligence', 'Read the business data guide')}${ghost('/pricing', 'See pricing')}</div>
      </div>
    </section>
    ...
    ${renderFinalCta('Bring the business question.', 'Send the market, service line, and the decision you are trying to make. We will read the business context against the outside market.', 'Request Your Free Snapshot')}
  `;
}
  ...
  return `
    <section class="page-hero article-hero">
      <div class="container">
        ...
        <div class="hero-actions">${cta('/request-snapshot', 'Request Your Free Snapshot')}${ghost('/insights', 'All insights')}</div>
      </div>
    </section>
    ...
    ${renderFinalCta('Need the answer for your market?', 'Send one market, one lane, and the business context. We will inspect the evidence before recommending the next move.', 'Request Your Free Snapshot')}
  `;
}
...
function renderIndustryIntelligence() {
  ...
  return `
    ...
    ${renderFinalCta('Bring us one market question.', 'We will read the demand, competitors, objections, and business context before recommending what to do next.', 'Request Your Free Snapshot')}
  `;
}
